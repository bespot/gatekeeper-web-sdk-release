...
| [Smoke test](examples/smoke-test/) | Manual UMD/ESM credential check against `dist/` |
...
6. **Optional — verify credentials** — serve this repo and open the [UMD](examples/smoke-test/umd.html) or [ESM](examples/smoke-test/esm.html) smoke page ([smoke test README](examples/smoke-test/))
...
Starter pages: [templates/integration-esm.html](templates/integration-esm.html), [templates/integration-umd.html](templates/integration-umd.html). Credential smoke tests: [examples/smoke-test/](examples/smoke-test/).
